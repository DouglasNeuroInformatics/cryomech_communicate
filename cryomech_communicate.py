#!/usr/bin/env python
# Script to readout PTC data through ethernet connection.
# Originaly from socs project
# https://github.com/simonsobs/socs
# Tamar Ervin and Jake Spisak, February 2019
# Modifications by Gabriel A. Devenyi <gabriel.devenyi@mcgill.ca>
# 2020-04
# - make standalone command line
# - add lookup tables on status codes
# - make number conversion uniform using struct.unpack
